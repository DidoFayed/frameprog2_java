package com.shopbag.store.store.controller;
...
import com.shopbag.store.store.domain.ArticleBuilder;
import com.shopbag.store.store.domain.Brand;
import com.shopbag.store.store.domain.Category;
import com.shopbag.store.store.domain.Size;
import com.shopbag.store.store.service.ArticleService;
